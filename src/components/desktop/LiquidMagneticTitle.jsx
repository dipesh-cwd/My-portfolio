  ...
  useEffect(() => {
    ...
    function loop() {
      ...
      if (maxOffset > 0.01) {
        ...
        // Motion has settled (offsets < 0.01px): snap letters back to rest.
        // Note: the original code also started a gsap tween here, but a second `overwrite: true`
        // tween immediately killed it, so it never ran. Direct style resets are equivalent.
        letters.forEach((el) => {
          el.style.transform = "";
          el.style.willChange = "";
